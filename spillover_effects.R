...
sdmat = matrix(0,1199,7)
ermat = matrix(0,1199,7)
for(k in 1:7){
...
sp500vol = sdmat[2:T,1]
sp500vol_1 = sdmat[1:(T-1),1]
TSX60vol = sdmat[2:T,2]
TSX60vol_1 = sdmat[1:(T-1),2]
Nikkeivol = sdmat[2:T,3]
Nikkeivol_1 = sdmat[1:(T-1),3]
MIB30vol = sdmat[2:T,4]
MIB30vol_1 = sdmat[1:(T-1),4]
DAX40vol = sdmat[2:T,5]
DAX40vol_1 = sdmat[1:(T-1),5]
CAC40vol = sdmat[2:T,6]
CAC40vol_1 = sdmat[1:(T-1),6]
FTSE100vol = sdmat[2:T,7]
FTSE100vol_1 = sdmat[1:(T-1),7]

# Vector Autoregressive Part

var1 <- lm(sp500vol~sp500vol_1+TSX60vol_1+Nikkeivol_1
           +MIB30vol_1+DAX40vol_1+CAC40vol_1+FTSE100vol_1)
...
var7 <- lm(FTSE100vol~sp500vol_1+TSX60vol_1+Nikkeivol_1
           +MIB30vol_1+DAX40vol_1+CAC40vol_1+FTSE100vol_1)

PHI1 = matrix(c(summary(var1)$coefficients[2:8,1],
                summary(var2)$coefficients[2:8,1],
                summary(var3)$coefficients[2:8,1],
                summary(var4)$coefficients[2:8,1],
                summary(var5)$coefficients[2:8,1],
                summary(var6)$coefficients[2:8,1],
                summary(var7)$coefficients[2:8,1]
                ),7,7
)

PHI1 = t(PHI1)

residual = data.frame(var1$residuals,var2$residuals,var3$residuals,var4$residuals,var5$residuals,var6$residuals,var7$residuals)
...
e1 = matrix(c(1,0,0,0,0,0,0),7,1)
e2 = matrix(c(0,1,0,0,0,0,0),7,1)
e3 = matrix(c(0,0,1,0,0,0,0),7,1)
e4 = matrix(c(0,0,0,1,0,0,0),7,1)
e5 = matrix(c(0,0,0,0,1,0,0),7,1)
e6 = matrix(c(0,0,0,0,0,1,0),7,1)
e7 = matrix(c(0,0,0,0,0,0,1),7,1)
...
theta_17 = sqrt(Sigma[7,7])^(-1)*((t(e1)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e1)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e1)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e1)%*%A3%*%Sigma%*%e7)^2)/
  (t(e1)%*%A0%*%Sigma%*%A0%*%e1+(t(e1)%*%A1%*%Sigma%*%A0%*%e1)
...
theta_1st = c(theta_11/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_12/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_13/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_14/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_15/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_16/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17),
              theta_17/(theta_11+theta_12+theta_13+theta_14+theta_15+theta_16+theta_17))
...
theta_27 = sqrt(Sigma[7,7])^(-1)*((t(e2)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e2)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e2)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e2)%*%A3%*%Sigma%*%e7)^2)/
  (t(e2)%*%A0%*%Sigma%*%A0%*%e2+(t(e2)%*%A1%*%Sigma%*%A0%*%e2)
...
theta_2st = c(theta_21/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_22/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_23/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_24/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_25/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_26/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27),
              theta_27/(theta_21+theta_22+theta_23+theta_24+theta_25+theta_26+theta_27))
...
theta_37 = sqrt(Sigma[7,7])^(-1)*((t(e3)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e3)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e3)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e3)%*%A3%*%Sigma%*%e7)^2)/
  (t(e3)%*%A0%*%Sigma%*%A0%*%e3+(t(e3)%*%A1%*%Sigma%*%A0%*%e3)
...
theta_3st = c(theta_31/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_32/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_33/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_34/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_35/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_36/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37),
              theta_37/(theta_31+theta_32+theta_33+theta_34+theta_35+theta_36+theta_37))
...
theta_47 = sqrt(Sigma[7,7])^(-1)*((t(e4)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e4)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e4)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e4)%*%A3%*%Sigma%*%e7)^2)/
  (t(e4)%*%A0%*%Sigma%*%A0%*%e4+(t(e4)%*%A1%*%Sigma%*%A0%*%e4)
...
theta_4st = c(theta_41/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_42/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_43/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_44/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_45/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_46/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47),
              theta_47/(theta_41+theta_42+theta_43+theta_44+theta_45+theta_46+theta_47))
...
theta_57 = sqrt(Sigma[7,7])^(-1)*((t(e5)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e5)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e5)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e5)%*%A3%*%Sigma%*%e7)^2)/
  (t(e5)%*%A0%*%Sigma%*%A0%*%e4+(t(e5)%*%A1%*%Sigma%*%A0%*%e5)
...
theta_5st = c(theta_51/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_52/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_53/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_54/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_55/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_56/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57),
              theta_57/(theta_51+theta_52+theta_53+theta_54+theta_55+theta_56+theta_57))
...
theta_67 = sqrt(Sigma[7,7])^(-1)*((t(e6)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e6)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e6)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e6)%*%A3%*%Sigma%*%e7)^2)/
  (t(e6)%*%A0%*%Sigma%*%A0%*%e6+(t(e6)%*%A1%*%Sigma%*%A0%*%e6)
...
theta_6st = c(theta_61/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_62/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_63/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_64/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_65/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_66/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67),
              theta_67/(theta_61+theta_62+theta_63+theta_64+theta_65+theta_66+theta_67))

# FTSE100

theta_71 = sqrt(Sigma[1,1])^(-1)*((t(e7)%*%A0%*%Sigma%*%e1)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e1)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e1)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e1)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
   +(t(e7)%*%A2%*%Sigma%*%A0%*%e7)+(t(e7)%*%A3%*%Sigma%*%A0%*%e7))

theta_72 = sqrt(Sigma[2,2])^(-1)*((t(e7)%*%A0%*%Sigma%*%e2)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e2)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e2)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e2)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_73 = sqrt(Sigma[3,3])^(-1)*((t(e7)%*%A0%*%Sigma%*%e3)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e3)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e3)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e3)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_74 = sqrt(Sigma[4,4])^(-1)*((t(e7)%*%A0%*%Sigma%*%e4)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e4)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e4)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e4)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_75 = sqrt(Sigma[5,5])^(-1)*((t(e7)%*%A0%*%Sigma%*%e5)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e5)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e5)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e5)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_76 = sqrt(Sigma[6,6])^(-1)*((t(e7)%*%A0%*%Sigma%*%e6)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e6)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e6)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e6)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_77 = sqrt(Sigma[7,7])^(-1)*((t(e7)%*%A0%*%Sigma%*%e7)^2
                                  +(t(e7)%*%A1%*%Sigma%*%e7)^2
                                  +(t(e7)%*%A2%*%Sigma%*%e7)^2
                                  +(t(e7)%*%A3%*%Sigma%*%e7)^2)/
  (t(e7)%*%A0%*%Sigma%*%A0%*%e7+(t(e7)%*%A1%*%Sigma%*%A0%*%e7)
...
theta_7st = c(theta_71/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_72/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_73/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_74/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_75/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_76/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77),
              theta_77/(theta_71+theta_72+theta_73+theta_74+theta_75+theta_76+theta_77))

# Spillover to all other 

theta1all = sum(theta_1st[2:7])
theta2all = sum(theta_2st[1:7])-theta_2st[2]
theta3all = sum(theta_3st[1:7])-theta_3st[3]
theta4all = sum(theta_4st[1:7])-theta_4st[4]
theta5all = sum(theta_5st[1:7])-theta_5st[5]
theta6all = sum(theta_6st[1:7])-theta_6st[6]
theta7all = sum(theta_7st[1:6])

# Spillover from all other

thetaall1 = theta_2st[1]+theta_3st[1]+theta_4st[1]+theta_5st[1]+theta_6st[1]+theta_7st[1]
thetaall2 = theta_1st[2]+theta_3st[2]+theta_4st[2]+theta_5st[2]+theta_6st[2]+theta_7st[2]
thetaall3 = theta_1st[3]+theta_2st[3]+theta_4st[3]+theta_5st[3]+theta_6st[3]+theta_7st[3]
thetaall4 = theta_1st[4]+theta_2st[4]+theta_3st[4]+theta_5st[4]+theta_6st[4]+theta_7st[4]
thetaall5 = theta_1st[5]+theta_2st[5]+theta_3st[5]+theta_4st[5]+theta_6st[5]+theta_7st[5]
thetaall6 = theta_1st[6]+theta_2st[6]+theta_3st[6]+theta_4st[6]+theta_5st[6]+theta_7st[6]
thetaall7 = theta_1st[7]+theta_2st[7]+theta_3st[7]+theta_4st[7]+theta_5st[7]+theta_6st[7]

# Good Volatility

sp500gdvol = sdmat[2:T,1]*(retmat[2:T,2]>ermat[2:T,1])
sp500gdvol_1 = sdmat[1:(T-1),1]*(retmat[1:(T-1),2]>ermat[1:(T-1),1])
TSX60gdvol = sdmat[2:T,2]*(retmat[2:T,3]>ermat[2:T,2])
TSX60gdvol_1 = sdmat[1:(T-1),2]*(retmat[1:(T-1),3]>ermat[1:(T-1),2])
Nikkeigdvol = sdmat[2:T,3]*(retmat[2:T,4]>ermat[2:T,3])
Nikkeigdvol_1 = sdmat[1:(T-1),3]*(retmat[1:(T-1),4]>ermat[1:(T-1),3])
MIB30gdvol = sdmat[2:T,4]*(retmat[2:T,5]>ermat[2:T,4])
MIB30gdvol_1 = sdmat[1:(T-1),4]*(retmat[1:(T-1),5]>ermat[1:(T-1),4])
DAX40gdvol = sdmat[2:T,5]*(retmat[2:T,6]>ermat[2:T,5])
DAX40gdvol_1 = sdmat[1:(T-1),5]*(retmat[1:(T-1),6]>ermat[1:(T-1),5])
CAC40gdvol = sdmat[2:T,6]*(retmat[2:T,7]>ermat[2:T,6])
CAC40gdvol_1 = sdmat[1:(T-1),6]*(retmat[1:(T-1),7]>ermat[1:(T-1),6])
...
theta6all_gd = sum(theta_gd_6st[1:5])
...
sp500gd0vol = sdmat[2:T,1]*(retmat[2:T,2]>0)
sp500gd0vol_1 = sdmat[1:(T-1),1]*(retmat[1:(T-1),2]>0)
TSX60gd0vol = sdmat[2:T,2]*(retmat[2:T,3]>0)
TSX60gd0vol_1 = sdmat[1:(T-1),2]*(retmat[1:(T-1),3]>0)
Nikkeigd0vol = sdmat[2:T,3]*(retmat[2:T,4]>0)
Nikkeigd0vol_1 = sdmat[1:(T-1),3]*(retmat[1:(T-1),4]>0)
MIB30gd0vol = sdmat[2:T,4]*(retmat[2:T,5]>0)
MIB30gd0vol_1 = sdmat[1:(T-1),4]*(retmat[1:(T-1),5]>0)
DAX40gd0vol = sdmat[2:T,5]*(retmat[2:T,6]>0)
DAX40gd0vol_1 = sdmat[1:(T-1),5]*(retmat[1:(T-1),6]>0)
CAC40gd0vol = sdmat[2:T,6]*(retmat[2:T,7]>0)
CAC40gd0vol_1 = sdmat[1:(T-1),6]*(retmat[1:(T-1),7]>0)
...
theta6all_gd0 = sum(theta_gd0_6st[1:5])
...
sp500bdvol = sdmat[2:T,1]*(retmat[2:T,2]<ermat[2:T,1])
sp500bdvol_1 = sdmat[1:(T-1),1]*(retmat[1:(T-1),2]<ermat[1:(T-1),1])
TSX60bdvol = sdmat[2:T,2]*(retmat[2:T,3]<ermat[2:T,2])
TSX60bdvol_1 = sdmat[1:(T-1),2]*(retmat[1:(T-1),3]<ermat[1:(T-1),2])
Nikkeibdvol = sdmat[2:T,3]*(retmat[2:T,4]<ermat[2:T,3])
Nikkeibdvol_1 = sdmat[1:(T-1),3]*(retmat[1:(T-1),4]<ermat[1:(T-1),3])
MIB30bdvol = sdmat[2:T,4]*(retmat[2:T,5]<ermat[2:T,4])
MIB30bdvol_1 = sdmat[1:(T-1),4]*(retmat[1:(T-1),5]<ermat[1:(T-1),4])
DAX40bdvol = sdmat[2:T,5]*(retmat[2:T,6]<ermat[2:T,5])
DAX40bdvol_1 = sdmat[1:(T-1),5]*(retmat[1:(T-1),6]<ermat[1:(T-1),5])
CAC40bdvol = sdmat[2:T,6]*(retmat[2:T,7]<ermat[2:T,6])
CAC40bdvol_1 = sdmat[1:(T-1),6]*(retmat[1:(T-1),7]<ermat[1:(T-1),6])
...
var5 <- lm(DAX40bdvol~sp500bdvol_1+TSX60bdvol_1+Nikkeibdvol_1
           +MIB30bdvol_1+DAX40bdvol_1+CAC40bdvol_1)
...
theta6all_bd = sum(theta_bd_6st[1:5])
...
sp500bd0vol = sdmat[2:T,1]*(retmat[2:T,2]<0)
sp500bd0vol_1 = sdmat[1:(T-1),1]*(retmat[1:(T-1),2]<0)
TSX60bd0vol = sdmat[2:T,2]*(retmat[2:T,3]<0)
TSX60bd0vol_1 = sdmat[1:(T-1),2]*(retmat[1:(T-1),3]<0)
Nikkeibd0vol = sdmat[2:T,3]*(retmat[2:T,4]<0)
Nikkeibd0vol_1 = sdmat[1:(T-1),3]*(retmat[1:(T-1),4]<0)
MIB30bd0vol = sdmat[2:T,4]*(retmat[2:T,5]<0)
MIB30bd0vol_1 = sdmat[1:(T-1),4]*(retmat[1:(T-1),5]<0)
DAX40bd0vol = sdmat[2:T,5]*(retmat[2:T,6]<0)
DAX40bd0vol_1 = sdmat[1:(T-1),5]*(retmat[1:(T-1),6]<0)
CAC40bd0vol = sdmat[2:T,6]*(retmat[2:T,7]<0)
CAC40bd0vol_1 = sdmat[1:(T-1),6]*(retmat[1:(T-1),7]<0)
...
theta6all_bd0 = sum(theta_bd0_6st[1:5])
...
thetatoall = c(theta1all_gd-theta1all_bd,theta2all_gd-theta2all_bd,theta3all_gd-theta3all_bd,
  theta4all_gd-theta4all_bd,theta5all_gd-theta5all_bd,theta6all_gd-theta6all_bd,theta7all_gd-theta7all_bd)

thetatoall0 = c(theta1all_gd0-theta1all_bd0,theta2all_gd0-theta2all_bd0,theta3all_gd0-theta3all_bd0,
  theta4all_gd0-theta4all_bd0,theta5all_gd0-theta5all_bd0,theta6all_gd0-theta6all_bd0,theta7all_gd0-theta7all_bd0)

thetatoall-thetatoall0

thetaallto = c(thetaall1_gd-thetaall1_bd,thetaall2_gd-thetaall2_bd,thetaall3_gd-thetaall3_bd,
  thetaall4_gd-thetaall4_bd,thetaall5_gd-thetaall5_bd,thetaall6_gd-thetaall6_bd,thetaall7_gd-thetaall7_bd)

thetaallto0 = c(thetaall1_gd0-thetaall1_bd0,thetaall2_gd0-thetaall2_bd0,thetaall3_gd0-thetaall3_bd0,
  thetaall4_gd0-thetaall4_bd0,thetaall5_gd0-thetaall5_bd0,thetaall6_gd0-thetaall6_bd0,thetaall7_gd0-thetaall7_bd0)

thetaallto - thetaallto0
